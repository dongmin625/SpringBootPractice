...
import root.dongmin.springbootdeveloper.config.oauth.OAuth2UserCustomService;
...
@Configuration
public class WebOAuthSecutiryConfig {
    ...
    public WebSecurityCustomizer configure(){ // 스프링 시큐리티 기능 비활성화
        return (web) -> web.ignoring() // 아래 경로들은 인증없이 접근가능
                .requestMatchers(toH2Console())
                .requestMatchers(
                        new AntPathRequestMatcher("/img/**"),
                        new AntPathRequestMatcher("/css/**"),
                        new AntPathRequestMatcher("/js/**") // 정적 리소스는 보안이 필요하지 않음
                );
    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                // 토큰 재발급은 URL 인증 없이 접근 가능하도록 설정. 나머지 API URL 은 인증 필요
